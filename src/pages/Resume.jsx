...
export const Resume = () => {
  return (
    <div className="min-h-screen bg-[#0f0f0f] text-white">
      ...
      <div className="pt-16 px-4 sm:px-8"> {/* Reduced padding for mobile */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="col-span-1 p-4 sm:p-6 rounded-lg  mb-6 lg:mb-0">
              <div className="flex flex-col items-center gap-6">
                <h2 className="text-xl sm:text-2xl font-bold text-blue-500 mb-4">CONTACT</h2>
                <div className="flex flex-col items-center">
                  ...
                  >
                    ...
                    <p className="text-blue-500 text-sm sm:text-lg">kevintandon123@gmail.com</p>
                  </a>
                </div>
                <div className="flex flex-col items-center">
                  <a 
                  ...
                  >
                    ...
                    <p className="text-blue-500 text-sm sm:text-lg">9136592098</p>
                  </a>
                </div>
                
                {/* External Links Section */}
                <h2 className="text-xl sm:text-2xl font-bold text-blue-500 mt-6 sm:mt-8 mb-4">EXTERNAL</h2>
                ...
                <div className="flex justify-center w-full">
                  <a 
                    href="https://drive.google.com/uc?export=download&id=1_1pAFtDPVl-WBMAzcboS_rUXwHbUpTkp"
                    download
                  ...
                  >
                    <img 
                      ...
                      className="w-10 h-10 sm:w-16 sm:h-16"
                    />
                    <span className="text-blue-500 font-semibold ml-2 text-sm sm:text-base">Download Resume</span>
                  </a>
                </div>
              </div>
            </div>
